...
## 💡 Highlighted Projects (Visible Innovation)

These projects showcase my ability to deliver measurable value through software and data analysis.

### 1. 🌍 Critical Geo-Automation Engine (Hours Saved via API Integration)
...
As a Data professional, my impact extends beyond code.

* **Effective Communication:** Proven experience delivering technical talks and presentations to large audiences (up to 500 people), translating complex concepts into clear, actionable insights.
* **Technical Mentorship:** Developed a repository with practical HTML/CSS exercises to train non-technical personnel, fostering foundational programming literacy.
* **Research and Security:** Authored a research paper focused on Security in the Cloud Computing environment.
